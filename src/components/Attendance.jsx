  ...
  return (
    <>
      <div className="bg-[#FFFFFF] w-screen">
        <h2 className="font-[700] text-[42px] md:text-[48px] text-primary text-center w-fit md:max-w-[398px] md:mx-auto leading-[46px] md:leading-[57.6px]">
          Get the Academy Attendance App
        </h2>

        <p className="font-[400] text-[16px] md:leading-[32px] w-fit md:w-[895px] mt-[32px] mb-[36px] md:mx-auto text-center">
